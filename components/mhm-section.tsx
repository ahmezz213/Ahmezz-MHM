        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div variants={itemVariants} className="bg-gray-900/50 rounded-lg border border-gray-800 p-6">
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-start">
                  <span className="text-blue-500 mr-2">•</span>Automated appointment scheduling
                </li>
                <li className="flex items-start">
                  <span className="text-blue-500 mr-2">•</span>Patient inquiry management
                </li>
                <li className="flex items-start">
                  <span className="text-blue-500 mr-2">•</span>Treatment information and FAQs
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-gray-900/50 rounded-lg border border-gray-800 p-6">
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-start">
                  <span className="text-purple-500 mr-2">•</span>Lead qualification and nurturing
                </li>
                <li className="flex items-start">
                  <span className="text-purple-500 mr-2">•</span>Property information delivery
                </li>
                <li className="flex items-start">
                  <span className="text-purple-500 mr-2">•</span>Viewing scheduling automation
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="bg-gray-900/50 rounded-lg border border-gray-800 p-6">
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-start">
                  <span className="text-indigo-500 mr-2">•</span>Project inquiry handling
                </li>
                <li className="flex items-start">
                  <span className="text-indigo-500 mr-2">•</span>Client communication automation
                </li>
                <li className="flex items-start">
                  <span className="text-indigo-500 mr-2">•</span>Scheduling and project updates
                </li>
              </ul>
            </motion.div>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-lg border border-gray-800 p-8 text-center">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Button
                onClick={openCal}
                variant="outline"
                className="border-gray-700 hover:bg-gray-800 text-lg px-8 py-6 bg-transparent"
              >
                Learn More
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    ...
                    AI agent development and automation, he oversees product development, client relationships, and
                    company growth.
                  </p>
                </div>
              </div>
